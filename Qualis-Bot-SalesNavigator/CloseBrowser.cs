...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("7666c5fa-d022-4de7-9a74-5052e2f702ee", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'InicioSalesNavigator'.", repo.InicioSalesNavigator.SelfInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.InicioSalesNavigator.Self, 1000);
